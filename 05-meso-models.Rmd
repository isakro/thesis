...
```{r t1, echo = FALSE, fig.align="center",  fig.cap="Central evidential arguments underlying Paper 1 presented as a Toulmin-like argument schema inspired by Chapman and Wylie (2016)."}
